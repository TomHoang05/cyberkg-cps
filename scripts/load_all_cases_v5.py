"""load_all_cases_v5.py — Full KG load from 10-Jul split-file data.

Loads all 4 attack cases from the 10-Jul data directory using loader_v5,
which adds plane multi-labels and relationship provenance on top of the
10-Jul baseline loader.
...
Prerequisites:
  ...
  - .env file at project root with NEO4J_URI / NEO4J_USER / NEO4J_PASSWORD
...
from src.kg.loader_v5 import load_shared, load_case   # noqa: E402
...
def main() -> None:
    log.info("load_all_cases_v5.py  — CyberKG-CPS full load (10-Jul data)")
    ...
    print()
    print("=" * 64)
    print("  LOAD SUMMARY (v5 — split files, plane labels, edge provenance)")
    print("=" * 64)
