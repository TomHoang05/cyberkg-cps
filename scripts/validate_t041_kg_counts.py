"""
T041 — KG Validation: Node Counts + Orphan Check
=================================================
...
Run:
    cd CyberKG-CPS
    python scripts/validate_t041_kg_counts.py
...
# ── Canonical expected values (CLAUDE.md §6 + CYB-25 §7.1) ──────────────────
EXPECTED_NODE_COUNT   = 104   # canonical post-MERGE: 15 ATT&CK + removed ITS-WRK2 (orphan, no relationships)
EXPECTED_EDGE_COUNT   = 149   # colonial T1021 revert (task #185) → 30+39+53+27 = 149
EXPECTED_REL_TYPES    = 17
EXPECTED_ENTITY_TYPES = 17   # 16 MVP + Question (Sprint 3)
...
CANONICAL_ENTITY_LABELS = {
    ...
    "Bridge_Mechanism", "Instructional_Concept", "Question",
}
...
def run_validation():
    ...
    with driver.session() as s:
        ...
        if missing_labels:
            ...
            ok(f"All {len(CANONICAL_ENTITY_LABELS)} entity labels present")
...
if __name__ == "__main__":
    print("CyberKG-CPS -- T041: KG Counts + Orphan Check")
